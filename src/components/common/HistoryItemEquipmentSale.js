...
class HistoryItemEquipmentSale extends Component {
	render() {
		...
		return (
			<div style={Object.assign({}, styles.boxSingleHistory, { borderBottomWidth: removeBorder ? 0 : 1 })} key={item.blockHash}>
				...
				<a
					...
					onClick={(e) => {
						e.preventDefault()
						this.props.history.push(`./item/${item.idnft}`)
					}}
				>
...
export default connect(mapStateToProps)(HistoryItemEquipmentSale)
