...
const test_p = require('../assets/gifs/part_player.gif')
const test_e = require('../assets/gifs/part_enemy.gif')


class DoFightTEST extends Component {
    constructor(props) {
        super(props)
        ...
        this.sfida = {
            "player1": {
                ...
                "nickname": "Karlov of the Ghost Council",
                "hp": {
                    "int": 60
                },
                "resistance": "spirit",
            ...
            "player2": {
                ...
                "pvpweek": "w12",
                "address": "k:0e3aa620854606481864ade05973cf30b2dfafc1ab40ce890c5201cee7a73911",
                "idnft": "1152",
                "level": 189,
            },
            "pvpWeek": "w12",
    ...
    componentDidMount() {
        ...
        setTimeout(() => {
            this.loadNft(this.sfida.player1.id, true)
        }, 500)
    }
            ...
            if (response.name) {
                ...
                this.props.getInfoItemEquipped(chainId, gasPrice, gasLimit, networkUrl, idNft, (ring) => {
                    ...
                    if (isPlayer1) {
                        ...
                        this.player1.spellSelected = this.refactorSpellSelected(this.sfida.player1.spellSelected)
                        ...
                        this.loadNft(this.sfida.player2.idnft, false)
                    }
                    else {
                        ...
                        this.player2.spellSelected = this.refactorSpellSelected(this.sfida.player2.spellSelected)
                ...
                <div style={{ justifyContent: 'space-between', width: boxW, position: 'relative' }}>
                    ...
                    <div style={{ width: widthSide, flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        <div style={{ width: widthImg, marginTop: isMobile ? 70 : 110, position: 'relative' }}>
                            ...
                            <img
                                style={{ position: 'absolute', width: widthImg, height: widthImg, top: 0, left: '-40%' }}
                                src={test_p}
                            />
                        ...
                        {/*<img
                            style={{ position: 'absolute', width: boxW, height: '100%', top: widthImg/2, left: 0 }}
                            src={test_p}
                        />*/}
                    </div>
                    ...
                    <div style={{ width: widthSide, flexDirection: 'column', alignItems: 'center', height: 'fit-content' }}>
                        ...
                        <div style={{ width: widthImg, height: widthImg, marginBottom: isMobile ? 70 : 110, position: 'relative' }}>
                            ...
                            <img
                                style={{ position: 'absolute', width: widthImg, height: widthImg, top: 0, left: 0 }}
                                src={test_e}
                            />
                        </div>
                    ...
                    {/* <img style={{ width: boxW, height: '100%', position: 'absolute', bottom: 0, left: 0 }} src={anim_test} /> */}
