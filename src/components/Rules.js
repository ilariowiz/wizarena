        ...
        return (
            <div style={{ width: boxW, alignItems: 'center', flexDirection: 'column', paddingTop: 30 }}>
                ...
                <div style={{ width: '100%', flexDirection: 'column' }}>
                    ...
                    Each wizard has this 7 stats: HP, Defense, Attack, Damage, Spells, Resistance, and Weakness. Let's analyze them quickly:<br /><br />
                    ...
                    - Attack. Your bonus to hit the opponent wizard with your spells, opposed by his Defense (and some bonuses or penalties)<br /><br />
                    - Damage. The points subtracted from your opponent's HP after the hit<br /><br />
                    - Spells. Shots available to your wizard, each with one of the 6 elements associated.<br /><br />
                    ...
                    <p style={{ fontSize: 18, color: 'white', lineHeight: 1.2, marginBottom: 10 }}>
                        ...
                        The tournament is simple, you pay the registration in KDA and the algorithm will do the rest.<br /><br />
                        ...
                        Participation will grant a random bonus that will increase HP or defense or attack or damage to all the wizards involved.<br /><br />
