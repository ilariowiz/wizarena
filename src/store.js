...
const saveSubsetMain = createFilter(
	'mainReducer',
	['account', 'chainId', 'isXWallet', 'isQRWalletConnect', 'qrWalletConnectClient', 'wizardSelectedIdShop', 'kadenaname', 'hideNavBar', 'transactionsState', 'mainTextColor', 'mainBackgroundColor', 'isDarkmode', 'subscribed', 'subscribedWiza', 'subscribedElite', 'subscribedKdaSpellGraph', 'subscribedWizaSpellGraph', 'subscribedEliteSpellGraph']
)
