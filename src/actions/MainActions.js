...
export const setNetworkUrl = (netId, chainId) => {
	return (dispatch) => {
		...
		if (netId === TEST_NET_ID) {
			url = `https://api.testnet.chainweb-community.org/chainweb/0.0/${TEST_NET_ID}/chain/${chainId}/pact`;
		}
...
export const getWizaValue = (chainId, gasPrice = DEFAULT_GAS_PRICE, gasLimit = 12000, networkUrl, callback) => {
	return (dispatch) => {
...
export const getWizaKDAPool = (chainId, gasPrice = DEFAULT_GAS_PRICE, gasLimit = 12000, networkUrl, callback) => {
	return (dispatch) => {
